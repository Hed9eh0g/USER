...
public class AlgoUSER_123 {
                ...
                for (int j = 0; j < itemset.size(); j++) {
                    ...
                    for (int k = i + 1; k < sequence.getItemsets().size(); k++) {
                        ...
                        for (ItemWithUtilityPosition itemY : itemsetK) {
                            ...
                            //EstimatedUtilityAndInformationList ListRuleInformation;
                            ...
                            //RuleInformation.AlphaPosition = sequence.ItemFirstPosition.get(itemX.getItemName());
    ...
    private void saveRule(int[] antecedent, int[] consequent,
        ...
        /*
        if (antecedent.length == 3 && consequent.length == 3) {
            if (antecedent[0] == 8 && antecedent[1] == 33 && antecedent[2] == 72 && consequent[0] == 10 && consequent[1] == 31 && consequent[2] == 41) {
...
//		// for each sequence containing the original rule (according to its utility table)
        for (ElementOfTable element : table.elements) {
            ...
            for (int i = element.positionBetaItemset; i < sequence.size(); i++) {
                ...
                for (int j = 0; j < itemsetI.size(); j++) {
                    ...
                    if (ItemJHasBeenExpanded.containsKey(itemJ.getItemName())) {
                    ...
                    double MaxUtilityItemJ = test.MaxUtilityItemBetweenAlphaAndBeta(itemJ, itemJ.position(), sequence.size() - 1, sequence, 1).utility();
                    ...
                    /*
                    if (antecedent.length == 1 && consequent.length == 1) {
                        if (antecedent[0] == 8 && consequent[0] == 10 && itemJ.getItemName() == 380 && sequence.id == 9) {
                            System.out.println(1);
                        }
                    }
                    ...
                    //newElement.positionBeta.add(element.positionBetaItemset);
                    //newElement.positionAlpha.add(element.positionAlphaItemset);
                        ...
                        for (int w = itemsetZ.size() - 1; w >= 0; w--) {
                            ...
                            if (itemW.getItemName() < itemJ.getItemName()) {
                                ...
                                if (itemW.getItemName() < largestItemInAntecedent) {
                                    ...
                                    double MaxProfitItemW1 = test.MaxUtilityItemBetweenAlphaAndBeta(itemW, itemW.position(), sequence.size() - 1, sequence, 1).utility();
                                    // double MaxProfitItemW2 = test.MaxUtilityItemBetweenAlphaAndBeta(itemW, element.positionBetaItemset, itemW.position(), sequence, 0).utility();
            ...
            for (int i = element.positionBetaItemset - 1; i > element.positionAlphaItemset; i--) {
                ...
                for (int j = 0; j < itemsetI.size(); j++) {
                    ItemWithUtilityPosition itemJ = itemsetI.get(j);
                    if (antecedent.length == 1 && consequent.length == 1) {
                        if (antecedent[0] == 4 && consequent[0] == 7 && itemJ.getItemName() == 8) {
                            ;
                        }
                    }
                    ...
                    ElementOfTable FirstSeeItemJInII = null;
                    int SameSequenceElementsNum = 0;
                    ...
                    if (tableItemJ == null) {
                        ...
                        List<ElementOfTable> elements = tableItemJ.elements;
                        for (ElementOfTable tmpElement : elements) {
                            if (tmpElement.numeroSequence == element.numeroSequence) {
                                SameSequenceElementsNum++;
                                if (SameSequenceElementsNum > 1) {
                                    FirstSeeItemJInII = tmpElement;
                                    break;
                                }
                            }
                        }
                    ...
                    if (SameSequenceElementsNum > 1) {
                        newElement.utilityRight = FirstSeeItemJInII.utilityRight;
                        newElement.utilityLeft = FirstSeeItemJInII.utilityLeft;
                        newElement.utilityLeftRight = FirstSeeItemJInII.utilityLeftRight;
                    ...
                    for (int z = element.positionBetaItemset - 1; z >= i; z--) {
                        ...
                        for (int w = itemsetZ.size() - 1; w >= 0; w--) {
                            ...
                            if (wIsRight && itemW.getItemName() < itemJ.getItemName()) {
                                ...
                                //double MaxProfitItemW2=test.MaxUtilityItemBetweenAlphaAndBeta(itemW,itemW.position(),element.positionBetaItemset-1,sequence,1).utility();
                    ...
                    for (int z = i - 1; z > element.positionAlphaItemset; z--) {
                        ...
                        for (int w = itemsetZ.size() - 1; w >= 0; w--) {
                            ...
                            //double MaxProfitItemW1 = test.MaxUtilityItemBetweenAlphaAndBeta(itemW, element.positionAlphaItemset, element.positionBetaItemset, sequence, 0).utility();
                            //double MaxProfitItemW2 = test.MaxUtilityItemBetweenAlphaAndBeta(itemW, element.positionAlphaItemset, element.positionBetaItemset, sequence, 1).utility();
                            // double MaxProfitItemW1 = test.MaxUtilityItemBetweenAlphaAndBeta(itemW, itemW.position(), element.positionBetaItemset - 1, sequence, 1).utility();
                            if (wIsLeftRight && itemW.getItemName() < itemJ.getItemName()) {

                                double MaxProfitItemW1 = test.MaxUtilityItemBetweenAlphaAndBeta(itemW, element.positionAlphaItemset + 1, itemW.position(), sequence, 0).utility();
                                //double MaxProfitItemW2 = test.MaxUtilityItemBetweenAlphaAndBeta(itemW, 0, itemW.position(), sequence, 0).utility();
                                //newElement.utilityLeft += Math.max(itemW.utility(), MaxProfitItemW2);
    ...
    private void expandFirstLeft(UtilityTable utilityTable, int[] antecedent,
        ...
        /*
        if (antecedent.length == 1 && consequent.length == 2) {
            if (antecedent[0] == 8 && consequent[0] == 10 && consequent[1] == 14) {
                System.out.println(1);
            }
        }
        ...
        for (ElementOfTable element : utilityTable.elements) {
            ...
            for (int i = 0; i < element.positionBetaItemset; i++) {
                ...
                for (int j = 0; j < itemsetI.size(); j++) {
                    ...
                    /*
                    ElementTableLeft FirstSeeItemJInII = null;
                    int SameSequenceElementsNum = 0;
                    */
        ...
        for (Entry<Integer, UtilityTableLeft> entryItemTable : mapItemUtilityTable.entrySet()) {
            ...
            if (isHighUtility && confidence >= minConfidence) {
                ...
                if (DEBUG) {
                    // print the rule
                    System.out.println("\n\t  LOW UTILITY SEQ. RULE: " + Arrays.toString(antecedent) + "," + item +
                            " --> " + Arrays.toString(consequent) + "   utility " + utilityTable.utility
                            + " support : " + utilityTable.MapSequenceMaxUtilityList.size()
                            + " confidence : " + confidence);
    ...
    public void printStats(String input) {
        System.out.println("=============== USER algorithm pruning 123 ===================");
